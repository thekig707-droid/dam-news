    ...
    <nav className="border-b border-gray-300 bg-white w-full sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          {/* Left Side: BBC Style Block Logo + Chhota NEWS */}
          <div className="flex-shrink-0 flex items-center">
            <Link href="/" onClick={closeMenu} className="flex items-center gap-2" title="DAM Home">
              {/* Aapke purane 3 D-A-M Blocks */}
              ...
              {/* Naya add kiya hua NEWS word */}
              <span className="text-black font-bold text-xl tracking-tight mt-0.5">NEWS</span>
            </Link>
          </div>
          
          {/* Right Side: Aapka original 3-line Menu Button */}
      ...
      {/* Dropdown Menu - EXACTLY jaisa aapne banaya tha */}
      {isOpen && (
